 ...
 */
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http.csrf().disable()
                ...
                .requestMatchers( "/api/demo1/users/authenticate","/swagger-ui/**","/swagger-ui/**","/socket/info").permitAll()
                ...
                .requestMatchers(
                        ...
                        "api/demo1/applications/user/add","api/demo1/applications/update/","api/demo1/applications/app/by-user","api/demo1/applications/counttotalbydev/",
                        "api/demo1/applications/byuser/","api/demo1/applications/app/byuser", 
                        // Tickets
                        ...
                        "api/demo1/users/authenticate","api/demo1/users/login"
                ).hasRole("DEVELOPER")
                .requestMatchers(
                        // Applications
